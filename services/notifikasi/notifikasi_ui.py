...
class NotifikasiUI:
    ...
    def menu(nik):
        while True:
            ...
            if pilihan == "1":
                ...
                NotifikasiUI.tampilkan_notifikasi(
                    nik=nik, jenis_referensi=JenisReferensi.DEPOSITO
                )

            elif pilihan == "3":
                NotifikasiUI.tampilkan_notifikasi(
                    nik=nik, jenis_referensi=JenisReferensi.PINJAMAN
                )
    ...
    def filter_notifikasi(nik, jenis_referensi=None):
        ...
        if jenis_referensi is not None:
            daftar_notifikasi = [
                ...
                if data_notif["jenis_referensi"] == jenis_referensi
            ]
    ...
    def tampilkan_notifikasi(nik, jenis_referensi=None):
        ...
        daftar_notif = NotifikasiUI.filter_notifikasi(
            nik=nik, jenis_referensi=jenis_referensi
        )
