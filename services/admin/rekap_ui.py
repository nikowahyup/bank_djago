...
class RekapUI:
        ...
        while True:
            ...
            if pilihan == "1":
                ...
                reguler, prioritas, gold, platinum = (
                    RekapService.rekap_jumlah_rekening()
                )
    ...
    def total_saldo_tiap_rekening(reguler, prioritas, gold, platinum):
        ...
        print(
            f"{UI.kelas[2]} Rekening Prioritas : Rp{Utilitas.format_rupiah(prioritas)}"
        )
        print(f"{UI.kelas[3]} Rekening Gold      : Rp{Utilitas.format_rupiah(gold)}")
        print(
            f"{UI.kelas[4]} Rekening Platinum  : Rp{Utilitas.format_rupiah(platinum)}\n"
        )
