...
class TransaksiService:
    ...
    def setor_tunai(nik_masuk, norek, nominal):
        ...
        if nominal < 10000:
            raise InputTidakValid("Minimal setor adalah Rp10.000")
        ...
        with buat_koneksi_tulis() as koneksi:
            ...
            if jumlah_baris != 1:
                raise PenambahanSaldoGagal("Gagal melakukan setor tunai")
    ...
    def tarik_tunai(nik_masuk, norek, nominal):
        ...
        if nominal < 10000:
            raise InputTidakValid("Minimal tarik adalah Rp10.000")
        ...
        with buat_koneksi_tulis() as koneksi:
            ...
            if jumlah_baris != 1:
                raise PenguranganSaldoGagal("Gagal melakukan tarik tunai")
    ...
    def transfer(nik_masuk, norek_pengirim, norek_penerima, nominal):
        ...
        with buat_koneksi_tulis() as koneksi:
            ...
            pengirim = RekeningLoader.muat_rekening(
                norek=norek_pengirim, koneksi=koneksi
            )

            if pengirim is None:
                raise RekeningTidakDitemukan("Rekening pengirim tidak terdaftar")
            ...
            if is_reset:
                ...
                RiwayatRepository.tambah_riwayat(
                    norek=pengirim.norek, riwayat=riwayat_reset, koneksi=koneksi
                )
            ...
            saldo_setelah_penerima = RekeningRepository.ambil_saldo(
                norek=penerima.norek, koneksi=koneksi
            )
            ...
            AuditRepository.tambah_audit(
                audit=audit_pengirim, koneksi=koneksi, id_transaksi=id_transaksi
            )
            AuditRepository.tambah_audit(
    ...
    @staticmethod
    def cari_penerima(norek_penerima, norek_pengirim, koneksi=None):

        from bank_djago.penyimpanan.loaders.rekening_loaders import RekeningLoader

        if norek_penerima == norek_pengirim:
            raise StatusTidakValid("Tidak dapat transfer ke nomor rekening sendiri")
        ...
        try:
            ...
            if penerima is None:
                raise RekeningTidakDitemukan("Rekening penerima tidak terdaftar")
    ...
    def transfer_semua_saldo(rekening_asal, norek_penerima, koneksi):
        ...
        if jumlah_baris_penerima != 1:
            raise PenambahanSaldoGagal("Gagal memindahkan saldo ke rekening penerima")
