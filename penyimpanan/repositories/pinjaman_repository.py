...
class PinjamanRepository:
    ...
    @staticmethod
    def perbarui_status_pinjaman(id_pinjaman, status_baru, koneksi, catatan=None):
        ...
        cursor = koneksi.execute(sql, (status_baru, catatan, id_pinjaman))
    ...
    @staticmethod
    def cari_detail_pinjaman(id_pinjaman, koneksi=None):
    ...
    @staticmethod
    def cari_semua_pinjaman_dengan_norek(norek, status, koneksi=None):
